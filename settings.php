...
<style>
    ...
    .form-switch .form-check-input:checked { background-color: #1a73e8; border-color: #1a73e8; }
</style>
...
<div class="google-wrapper">
    ...
    <main class="google-content w-100">
        <div class="container mt-4 mb-5 settings-container">
            ...
            <div class="d-flex align-items-center bg-white p-3 rounded-4 google-card mb-4 border-0">
                <?php 
            ...
            <h6 class="fw-bold mb-3 ms-2 text-muted" style="font-size: 0.85rem; text-transform: uppercase; letter-spacing: 0.5px;"><?php echo $lang['my_profile']; ?></h6>
            <div class="list-group google-card settings-group mb-4 bg-white border-0 p-0">
            ...
            <h6 class="fw-bold mb-3 ms-2 text-muted" style="font-size: 0.85rem; text-transform: uppercase; letter-spacing: 0.5px;"><?php echo $lang['settings']; ?></h6>
            <div class="list-group google-card settings-group mb-4 bg-white border-0 p-0">
            ...
            <h6 class="fw-bold mb-3 ms-2 text-muted" style="font-size: 0.85rem; text-transform: uppercase; letter-spacing: 0.5px;"><?php echo $lang['help_support']; ?></h6>
            <div class="list-group google-card settings-group mb-4 bg-white border-0 p-0">
                <a href="pages/help.php" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center settings-item">
                    <span><?php echo $lang['help_center']; ?></span>
                    <i class="bi <?php echo ($current_lang == 'ar') ? 'bi-chevron-left' : 'bi-chevron-right'; ?>"></i>
                </a>
                <a href="pages/privacy.php" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center settings-item">
                    <span><?php echo $lang['privacy_policy']; ?></span>
                    <i class="bi <?php echo ($current_lang == 'ar') ? 'bi-chevron-left' : 'bi-chevron-right'; ?>"></i>
                </a>
            </div>

            <div class="list-group google-card settings-group bg-white border-0 p-0">
