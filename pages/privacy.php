...
<div class="page-header-bg">
    <div class="container">
        <h1 class="page-title"><?php echo $lang['privacy_title'] ?? 'Privacy Policy'; ?></h1>
        <p class="page-subtitle"><?php echo $lang['privacy_subtitle'] ?? 'How we protect your data.'; ?></p>
    </div>
</div>
        ...
        <div class="col-lg-10">
            <div class="google-card">
                ...
                <div class="text-section">
                    <h3><?php echo $lang['privacy_sec1_title'] ?? ''; ?></h3>
                    <p><?php echo $lang['privacy_sec1_desc'] ?? ''; ?></p>
                </div>

                <div class="text-section">
                    <h3><?php echo $lang['privacy_sec2_title'] ?? ''; ?></h3>
                    <p><?php echo $lang['privacy_sec2_desc'] ?? ''; ?></p>
                </div>

                <div class="text-section mb-0">
                    <h3><?php echo $lang['privacy_sec3_title'] ?? ''; ?></h3>
                    <p class="mb-0"><?php echo $lang['privacy_sec3_desc'] ?? ''; ?></p>
                </div>
