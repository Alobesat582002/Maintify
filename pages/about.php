...
<div class="page-header-bg">
    <div class="container">
        ...
        <p class="page-subtitle"><?php echo $lang['about_subtitle'] ?? ''; ?></p>
    </div>
</div>
        ...
        <div class="col-lg-10">
            <div class="google-card">
                ...
                <div class="text-section">
                    <h3><?php echo $lang['about_sec1_title'] ?? ''; ?></h3>
                    <p><?php echo $lang['about_sec1_desc'] ?? ''; ?></p>
                </div>

                <div class="text-section mb-0">
                    <h3><?php echo $lang['about_sec2_title'] ?? ''; ?></h3>
                    <p class="mb-0"><?php echo $lang['about_sec2_desc'] ?? ''; ?></p>
                </div>
